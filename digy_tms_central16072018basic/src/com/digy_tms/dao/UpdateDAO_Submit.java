...
public class UpdateDAO_Submit {

	public String Update_register(MasterBean mb) {
		// TODO Auto-generated method stub
		String Course_key=mb.getCourse_key();
	...
	System.out.println("Inside the Update DAO SUbmit  "+ Course_key);
			
			conn=DBConnection.getDBConnection();
				String query="update course_master set Course_ID=?,Course_Name=?,Course_Short_name=?,Course_Type=?,Course_Category=?,"
						...
						+ "Course_Status=?,Course_created_by=?,Course_created_DtTm=?,Course_mod_by=?,Course_mod_DtTm=? where Course_Key = '"+Course_key+"' ";
			...
			//pst.setBigDecimal(20, Course_key);
				 i=pst.executeUpdate();
